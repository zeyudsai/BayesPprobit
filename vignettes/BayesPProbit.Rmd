...
- Ding, Z., et al. (2024). *Scalable Bayesian p-generalized probit and logistic regression*. Journal of Computational Statistics.
- Munteanu, A., et al. (2022). *p-Generalized probit regression and scalable maximum likelihood estimation*. Statistical Methods Journal.
